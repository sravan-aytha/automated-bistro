...
<img src="https://cdn2.vectorstock.com/i/1000x1000/09/31/cooking-time-lettering-design-for-kitchen-vector-22680931.jpg" width="200px" height="100px"/>
        ...
        <%
           ...
           <tr>
               ...
               <td><form action="cooking_stat.jsp" method="post"><input type="text" value=<%out.println(rs.getString(1));%> hidden="hidden" name="table"><input type="submit" value="start cooking"></form></td>
               <td><form action="cleantable.jsp" method="post"><input type="text" value=<%out.println(rs.getString(1));%> hidden="hidden" name="table"><input type="submit" value=" complete"></form></td>
        ...
        Class.forName("com.mysql.jdbc.Driver");
           ...
           <table>
               ...
               <tr>
                   ...
                   <td><form action="cooking.jsp" method="post"><input type="text" value=<%out.println(rs1.getString(1));%> name="table" hidden="hidden"> <input type="submit"  value="start cooking" name="table" ></form></td>
                   <td><form action="supply.jsp" method="post"><input type="text" value=<%out.println(rs1.getString(1));%> name="table" hidden="hidden"><input type="submit" value="complete"  name="table"></form></td>
               </tr> 
               <%}
               %>
           </table> 
